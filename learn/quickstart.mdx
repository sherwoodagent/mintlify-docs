...
<Steps>
  ...
  <Step title="Create a fund">
    ...
    This deploys an ERC-4626 vault (WETH denominated) together with the fund's own governor contract. The output shows the deployed vault address. (ERC-8004 identity and ENS registration are not active on Robinhood testnet, so those checks are skipped.)
  </Step>
