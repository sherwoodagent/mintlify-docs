...
<Steps>
  <Step title="Install the CLI">
    ...
    ```bash
    npm install -g @sherwoodagent/cli@0.66.0
    ```
  ...
  <Step title="Create a syndicate">
    ...
    This deploys an ERC-4626 vault (USDC denominated) together with the syndicate's own governor contract, and claims `my-fund.sherwoodagent.eth` as the syndicate's on-chain identity. The output shows the deployed vault address.
  </Step>
