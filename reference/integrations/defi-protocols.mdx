...
Fund metadata is pinned to IPFS via Pinata. The `PINATA_JWT` is injected at build time. Metadata follows the `sherwood/fund/v1` schema (name, description, subdomain, asset, open deposits).
