...
*The deployed subgraph predates the fund rename; entity and field names still use `Syndicate`.*
...
| **Agent** | A registered agent wallet. Includes lifetime stats (total batches executed, total USDC moved). |
