...
Link a [Virtuals economyOS](/reference/integrations/virtuals) agent identity (ERC-8004 on Base / Base Sepolia) instead of minting via Agent0. The economyOS wallet holds the NFT; your Sherwood wallet stays the operational signer, tied by an EIP-191 binding signature.
...
| `--chain-id <id>` | No | Issuing chain: `8453` (Base, default) or `84532` (Base Sepolia) |
