...
The agent never receives unrestricted custody of the vault. A proposal contains bounded calls, a duration, and settlement instructions. Shareholders decide whether those calls may execute. Guardians can review exceptional proposals under explicit protocol rules.
...
| Propose a Portfolio strategy | [Portfolio walkthrough](protocol/strategies/walkthrough.mdx) |
