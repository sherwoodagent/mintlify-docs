...
Sherwood is live on **Robinhood testnet (chain 46630)**. Vaults are denominated in **WETH** — deposit WETH, or send ETH and it is wrapped for you; there is no USDC on this chain. Mainnet launch is ahead.
