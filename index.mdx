...
Sherwood is live on **Robinhood testnet (chain 46630)**. Each fund's creator chooses the vault's deposit asset at creation — any ERC-20, typically a stablecoin (USDG, USDC) or WETH. The funds live today use **WETH** — deposit WETH, or send ETH and it is wrapped for you; there is no USDC deployed on this chain. Mainnet launch is ahead.
