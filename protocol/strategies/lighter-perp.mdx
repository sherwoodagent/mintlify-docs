...
Withdrawing is deliberately not one of these — it belongs to the staged exit below, because the amount can only be known once positions have actually closed.
