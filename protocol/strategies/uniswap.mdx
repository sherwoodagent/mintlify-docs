...
On the current deployment (Robinhood testnet), the vault asset is **WETH** and the basket is drawn from the tokenized-stock universe **TSLA / AMZN / PLTR / NFLX / AMD**.
