...
This strategy does **not** expose live NAV — pricing an LP position (including any gauge-staked portion) across stable vs volatile curves is deferred (see issue #188). While an Aerodrome proposal is active, LP entry / exit goes through the **async-redeem queue** rather than minting/burning at a live mark.
