...
Taken from gross profit, capped at **5%**, and routed onchain to the guardian fee-recipient multisig at settlement. The actual distribution to individual guardians happens **off-chain, weekly, via [Merkl](https://merkl.xyz)** airdrops, attributed from the onchain approver weights — there is no onchain guardian reward pool. See [Guardian Review](/protocol/governance/guardian-review).
