...
A focused slice of guardian coverage (to fold into the broader SHE-122 coverage page later). This is the **propose-path** bond only — not the SHE-126 fee split.
