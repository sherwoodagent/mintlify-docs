...
The management fee is unaffected by co-proposers: it is charged on asset-seconds before the performance leg, and only the **agent's slice** of it follows the co-proposer split.
